...
export default class SideNav extends React.PureComponent {
  ...
  renderCategoryImage = () => {
    ...
    {
      return(
        <img src={this.state.categoryImagePreview} className="newChallengeImagePreview"/>
      )
    }
    else {
      return(
  ...
  renderAdd = () => {
    ...
    {
      return(
        <div className="categoryButton"><AddIcon style={{cursor:'pointer'}} onClick={this.categoryDialog}/></div>
      )
    }
  }
    ...
    return (
      <div>
        ...
        {this.state.categories.map((c, i) => (
          <Link to={'/Discover/' + c.categorySlug} className="categoryBlock" key={i}>
            <img src={c.categoryImage} className="categoryIcon"/>
            <div className="categoryName">{c.categoryName}</div>
          </Link>
        ))}
        ...
        <Dialog onRequestClose={this.categoryDialog} open={this.state.categoryOpen}>
          ...
          <div style={{paddingLeft:'15px', paddingRight:'15px', paddingBottom:'15px'}}>
            ...
            />
            <div>
              <label htmlFor="category-image" className="challengeImageBlock">
