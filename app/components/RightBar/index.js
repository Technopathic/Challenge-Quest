...
export default class RightBar extends React.PureComponent {
  ...
  renderChallengeImage = () => {
    ...
    {
      return(
        <img src={this.state.challengeImagePreview} className="newChallengeImagePreview"/>
      )
    }
    else {
      return(
    ...
    return (
      <div>
        ...
        <div className="newsLetterBlock">
          <img className="newsLetterImage" src="http://challenges.innovationmesh.com/assets/newsletter.png"/> 
          <div className="categoryTitle" style={{width:'100%', textAlign:'center', marginTop:'5px', marginBottom:'7px'}}>Join our Monthly Newsletter</div>
          <input type="text" placeholder="Your E-mail" className="newsLetterInput"/>
          <FlatButton style={{background:'#32b6b6', color:'#FFFFFF', width:'100%', marginTop:'7px'}}>Subscribe</FlatButton>
        </div>
        <div className="newsLetterBlock">
          <img className="newsLetterImage" src="http://challenges.innovationmesh.com/assets/guide.png"/>
          <div className="categoryTitle" style={{width:'100%', textAlign:'center', marginTop:'5px', marginBottom:'7px'}}>Creating a Challenge</div>
        ...
        <Dialog onRequestClose={this.challengeDialog} open={this.state.challengeOpen} fullScreen transition={this.transition}>
          <div style={{display:'flex', flexDirection:'row'}}>
            <div style={{width:'30%', display:'flex', flexDirection:'column', padding:'15px'}} >
              ...
              />
              <div>
                <label htmlFor="challenge-image" className="challengeImageBlock">
              ...
              {this.state.challengeFiles.map((file, index) => (
                <div key={index}>
                  <div className="newFileBlock" ><span></span>{file.fileData.name} <CloseIcon size={25} style={{color:'#777777', padding:'5px', cursor:'pointer'}} onClick={() => this.deleteFile(index)}/></div>
                </div>
              ))}
              <div>
                <label htmlFor="challenge-file" className="newFileAdd">
                  Upload New File
                </label>
